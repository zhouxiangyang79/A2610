...
#define SIMPLEPROFILE_CHAR1_LEN     244
#define SIMPLEPROFILE_CHAR2_LEN     1
#define SIMPLEPROFILE_CHAR3_LEN     4
#define SIMPLEPROFILE_CHAR4_LEN     10
...
typedef void
(*simpleProfileChange_t)(uint8_t paramID, uint8_t *pValue, uint16_t len);
...
extern bStatus_t
SimpleProfile_AddService(uint32_t services);
 ...
 */
extern bStatus_t
SimpleProfile_RegisterAppCBs(simpleProfileCBs_t *appCallbacks);
 ...
 */
extern bStatus_t
SimpleProfile_SetParameter(uint8_t param, uint8_t len, void *value);
 ...
 */
extern bStatus_t
SimpleProfile_GetParameter(uint8_t param, void *value);
 ...
 */
extern bStatus_t
simpleProfile_Notify(uint16_t connHandle, attHandleValueNoti_t *pNoti);
/*
 * simpleProfile_Notify - Send notification.
 *
 *    connHandle - connect handle
 ...
 */
extern bStatus_t
simpleProfile_Notify_char1(uint16_t connHandle, attHandleValueNoti_t *pNoti);
